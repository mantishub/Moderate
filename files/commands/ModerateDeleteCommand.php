...
/**
 * Command to delete an item from the queue
 *
 * Sample data:
 * {
 *   "query": {
 ...
 * }
 */
class ModerateDeleteCommand extends Command {
	/**
	 * Queue item ID
	 * @var integer
	 */
	...
	protected function validate() {
		...
		if( !access_has_global_level( $t_approve_threshold ) ) {
			throw new ClientException(
				'Access denied to delete queue items',
				ERROR_ACCESS_DENIED
			);
		}
	...
	protected function process() {
		# Delete the item
		moderate_queue_delete( $this->queue_id );
